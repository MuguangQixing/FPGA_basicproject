...
REM
REM Generated by Vivado on Thu Nov 21 17:57:46 +0800 2024
...
echo "xvlog --incr --relax -prj tb_rgmireg_vlog.prj"
call xvlog  --incr --relax -prj tb_rgmireg_vlog.prj -log xvlog.log
